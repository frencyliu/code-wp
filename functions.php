...
//add_action( 'wp_enqueue_scripts', function() {	wp_enqueue_script('custom', get_stylesheet_directory_uri() . '/assets/js/custom.js', array(/* 'jquery' */), null, true); });
...
require_once __DIR__ . '/yc_custom/functions.php';
