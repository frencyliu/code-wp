...
$args['output_featured_image_class'] = isset($args['output_featured_image_class']) ? $args['output_featured_image_class'] : 'ratio-16x9';
...
<div class="<?php echo $args['column_classes']; ?> mb-2r">
    <article role="article" id="post-<?php echo $the_post->ID; ?>" class="row post-item <?php echo $args['output_article_class']; ?>">
        ...
        <div class="<?php echo ($args['output_article_class'] == 'featured') ? ('col-md-6 pe-md-0 ps-md-1hr') : ('col-12 px-md-0'); ?>">
            <div class="h-100">
